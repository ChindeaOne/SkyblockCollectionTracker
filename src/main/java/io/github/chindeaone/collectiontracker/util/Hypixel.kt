...
object Hypixel {
    ...
    private fun setConfigForNewVersion() {
        val scale = ModInitialization.configManager.config!!.overlay.overlaySingle.overlayPosition.scale
        if(scale == 0.0f){
            ModInitialization.configManager.config!!.overlay.overlaySingle.overlayPosition.setScaling(1.0f)
        }
    }

...
public class ValidCollectionsManager {
    ...
    static {
        ...
        validCollections.put("gemstone:amber", true);
        validCollections.put("gemstone:topaz", true);
        validCollections.put("gemstone:sapphire", true);
        validCollections.put("gemstone:amethyst", true);
        validCollections.put("gemstone:jasper", true);
        validCollections.put("gemstone:ruby", true);
        validCollections.put("gemstone:jade", true);
        validCollections.put("gemstone:opal", true);
        validCollections.put("gemstone:aquamarine", true);
        validCollections.put("gemstone:citrine", true);
        validCollections.put("gemstone:onyx", true);
        validCollections.put("gemstone:peridot", true);

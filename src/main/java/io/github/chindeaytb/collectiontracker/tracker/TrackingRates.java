...
import io.github.chindeaytb.collectiontracker.collections.prices.BazaarPrices;
import io.github.chindeaytb.collectiontracker.collections.prices.GemstonePrices;
...
public class TrackingRates {
    ...
    public static void calculateRates(String jsonResponse) {
        // Set bazaar config
        ModConfig config = ModInitialization.configManager.getConfig();
        assert config != null;
